...
def main():    
    ...
    input_colses = {  
        'MLFMbert': ['text_bert_indices', 'bert_segments_ids', 'attention_mask', 'deprel_adj', 'asp_start', 'asp_end', 'src_mask', 'aspect_mask']
    }
    ...
    parser.add_argument('--dataset', default='mams', type=str, help=', '.join(dataset_files.keys()))
    ...
    parser.add_argument('--vocab_dir', type=str, default='./dataset/MAMS_corenlp')
